    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, Booking_1.Booking.deleteMany({})];
                case 2:
                    _a.sent();
                    ...
                    fs.readFile('../data/booking.json', 'utf8', function (err, data) { return __awaiter(_this, void 0, void 0, function () {
                        var bookings, _loop_1, _i, bookings_1, booking;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (err) {
                                    ...
                                    _loop_1 = function (booking) {
                                        var newBooking;
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    newBooking = new Booking_1.Booking({
                                                        _id: new mongoose_1.default.Types.ObjectId(booking._id),
                                                        user: booking.user,
                                                    ...
                                                    return [4 /*yield*/, newBooking.save()
                                                            .then(function () {
                                                            console.log("Booking ".concat(booking.name, " saved successfully."));
                                                        })
                                                            .catch(function (error) {
                                                            console.error("Error saving Booking ".concat(booking.name, ":").concat(booking._id), error);
                                                        })];
                                                case 1:
                                                    _b.sent();
                                                    return [2 /*return*/];
                                    ...
                                    _a.label = 1;
                                case 1:
                                    if (!(_i < bookings_1.length)) return [3 /*break*/, 4];
                                    booking = bookings_1[_i];
                                    return [5 /*yield**/, _loop_1(booking)];
                                case 2:
                                    _a.sent();
                                    _a.label = 3;
                                case 3:
